...
def validate_register(request):
    ...
    if can_proceed == True:
        ...
        return render(request,'bot/Register.html',context={'error_message':error_message,'valuedict':fieldvalue_dict})
...
def userprofile_page(request):
    ...
    return render(request,'bot/userprofile.html',context={'image_url':pic_url})